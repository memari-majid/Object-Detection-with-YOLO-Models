...
model = YOLO('yolov10x.pt')  # Load the YOLO model (adjust the model variant as needed)

# Use both GPUs (GPU 0 and GPU 1)
model.train(data='/home/majid/PycharmProjects/E5/data/data.yml', epochs=100, imgsz=640, batch=16, name='yolov10_experiment', device='0,1')
